...
# generated file type
    ...
    echo "https://doh.pub/dns-query" >>adguardhome_gfwlist.txt  #DNSPod
    echo "https://dns.alidns.com/dns-query" >>adguardhome_gfwlist.txt   #AliDNS
    echo "[/tongji.edu.cn/]202.120.190.208" >>adguardhome_gfwlist.txt   #Tongji DNS
